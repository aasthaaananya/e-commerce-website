                    ...
                    return (
                      <Fragment key={orderProduct.product.id}>
                        <div className="product-image-container">
                          <img
                            src={orderProduct.product.image?.startsWith('/') ? orderProduct.product.image : `/${orderProduct.product.image}`}
                        ...
                        <div className="product-details">
                          ...
                          <div className="product-quantity">Quantity: {orderProduct.quantity ?? 1}</div>
